...
import { signUp, authClient as client } from "@/lib/auth-client";
      ...
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)} className="grid gap-4">
          ...
          <div className="relative flex items-center">
            ...
            <span className="mx-4 flex-shrink text-xs text-muted-foreground uppercase">Or</span>
            <div className="flex-grow border-t border-neutral-200 dark:border-neutral-800" />
          </div>
