      ...
      <CardHeader className=" text-center">
        ...
        <CardDescription className="text-sm">
          <div className="leading-tight sm:text-balance">
            ...
            <Popover>
              <PopoverTrigger className="text-primary underline-offset-4 hover:underline inline px-1 font-medium focus-visible:ring-[3px] outline-none select-none">
                Need help?
              </PopoverTrigger>
              <PopoverContent className="w-xs text-sm">
                If you are a business owner or supplier, contact your administrator or us if you have trouble accessing your account. For new users, please sign up first.
                <br /><br />
          ...
          <section className="flex flex-col gap-2 mt-2">
            <div className={cn(
              ...
              >
                ...
                {/* {mounted && (client as any).isLastUsedLoginMethod?.("email") && <LastUsedIndicator />} */}
              </Button>
            </div>
            ...
            >
              ...
              >
                ...
                {/* {mounted && (client as any).isLastUsedLoginMethod?.("google") && <LastUsedIndicator />} */}
              </Button>
            </div>
          </section>
        </div>
